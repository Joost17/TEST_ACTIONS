...
:: 3. Vraag de gebruiker of de merge van test naar ontwikkel mag plaatsvinden
...
ECHO 4. Indien akkoord, voer een daadwerkelijke merge+push uit van de test branch naar de ontwikkel branch 
ECHO.
ECHO.
...
SET choice1=
SET /p choice1=Wil je een overzicht van de bestanden die verschillen tussen test en ontwikkel ? [Y/N]: 
...
SET choice2=
SET /p choice2=Do you want to merge test into ontwikkel (we voeren eerst een dummy merge uit op een tijdelijke branch) ? [Y/N]: 
...
ECHO We maken een tijdelijke branch "ontwikkel_temp" om de merge uit te voeren en het resultaat te bekijken
ECHO.

:: Doe een merge op een tijdelijke branch (identiek aan test) om te aanpassingen te testen
git checkout -b ontwikkel_temp ontwikkel
git merge test
git checkout ontwikkel
git branch -D ontwikkel_temp

ECHO.
SET choice3=
SET /p choice3= Wil je nu de daadwerkelijke merge+push uitvoeren van test naar ontwikkel? [Y/N]: 
...
ECHO We voeren een merge+push uit van de test branch naar de ontwikkel branch
ECHO.

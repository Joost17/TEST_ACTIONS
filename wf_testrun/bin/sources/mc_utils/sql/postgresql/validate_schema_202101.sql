...
-- 3. psql -f validate_schema_202101.sql -d <database> -U <user> -o validation_results_202101.txt
...
SELECT CASE WHEN t1.element_name IS NULL THEN t2.element_type ELSE t1.element_type END AS element_type,
  ...
  SELECT 'INDEX' AS element_type, 'MODULERUNTIMES.LOCALMODIFICATIONTIME' AS element_name, '1' AS element_content, 'idx_moduleruntimes_lmt' AS element_info UNION
  SELECT 'INDEX' AS element_type, 'MODULERUNTIMES.MODULEINSTANCEID' AS element_name, '2' AS element_content, 'idx_moduleruntimes_workflowid_' AS element_info UNION
  SELECT 'INDEX' AS element_type, 'MODULERUNTIMES.WORKFLOWID' AS element_name, '1' AS element_content, 'idx_moduleruntimes_workflowid_' AS element_info UNION
  ...
  SELECT 'PRIMARY KEY' AS element_type, 'MODULERUNTIMES.ENTRYID' AS element_name, '2' AS element_content, 'pk_moduleruntimes' AS element_info UNION
  SELECT 'PRIMARY KEY' AS element_type, 'MODULERUNTIMES.MCID' AS element_name, '1' AS element_content, 'pk_moduleruntimes' AS element_info UNION
  ...
  SELECT 'TABLE_COLUMN' AS element_type, 'FSSSTATUS.PROGRESSPERCENTAGE' AS element_name, 'TINYINT NOT NULL DEFAULT ''0''' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'FSSSTATUS.WORKFLOWNODEINDEX' AS element_name, 'NUMERIC(10) NOT NULL DEFAULT ''0''' AS element_content, '' AS element_info UNION
  ...
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULEINSTANCERUNS.RUNSTATUS' AS element_name, 'TINYINT NOT NULL DEFAULT ''0''' AS element_content, '' AS element_info UNION
  ...
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.CREATIONTIME' AS element_name, 'TIMESTAMP(3) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.ENTRYID' AS element_name, 'NUMERIC(19) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.GLOBALROWID' AS element_name, 'NUMERIC(19) NOT NULL DEFAULT NEXT VALUE FOR GLOBALROWIDSEQUENCE' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.LOCALMODIFICATIONTIME' AS element_name, 'TIMESTAMP(3) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.MAXPARTITION' AS element_name, 'NUMERIC(10) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.MCID' AS element_name, 'VARCHAR(64) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.MINPARTITION' AS element_name, 'NUMERIC(10) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.MODIFICATIONTIME' AS element_name, 'TIMESTAMP(3) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.MODULEINSTANCEID' AS element_name, 'VARCHAR(64) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.PENDINGDURATIONMILLIS' AS element_name, 'NUMERIC(19) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.RUNDURATIONMILLIS' AS element_name, 'NUMERIC(19) NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.VISIBLE' AS element_name, 'BIT NOT NULL' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.WORKFLOWID' AS element_name, 'VARCHAR(64) NOT NULL' AS element_content, '' AS element_info UNION
  ...
  SELECT 'TABLE_COLUMN' AS element_type, 'TASKRUNS.TIMEZERO' AS element_name, 'TIMESTAMP(3)' AS element_content, '' AS element_info UNION
  ...
  SELECT 'TABLE_COLUMN' AS element_type, 'TASKS.LASTCOMPLETEDDURATIONMILLIS' AS element_name, 'NUMERIC(19) NOT NULL DEFAULT ''0''' AS element_content, '' AS element_info UNION
  SELECT 'TABLE_COLUMN' AS element_type, 'TASKS.LASTCOMPLETEDTASKRUNID' AS element_name, 'VARCHAR(64)' AS element_content, '' AS element_info UNION
  ...
  SELECT 'UNIQUE INDEX' AS element_type, 'MODULERUNTIMES.GLOBALROWID' AS element_name, '1' AS element_content, 'idx_moduleruntimes_id' AS element_info UNION
...
SELECT table_name, table_catalog, table_schema, UPPER(table_name || '.' || column_name) AS element_name,
  CASE
    ...
    WHEN udt_name = 'bytea' THEN CASE a.attstorage WHEN 'p' THEN 'plain' WHEN 'm' THEN 'MAIN' WHEN 'e' THEN '' WHEN 'x' THEN 'EXTENDED' END || 'BLOB'
...
FROM information_schema.columns c, pg_attribute a, pg_class t, pg_namespace n
WHERE t.oid = a.attrelid AND t.relnamespace = n.oid AND c.column_name=a.attname
AND t.relname = c.table_name AND NOT a.attisdropped

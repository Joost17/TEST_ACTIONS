...
-- 3. sqlcmd -I -S<server> -d<database> -U<user> -P<password> -ivalidate_schema_202101.sql -o validation_results_202101.txt -W -w 400
...
SELECT CASE WHEN t1.element_name IS NULL THEN t2.element_type ELSE t1.element_type END AS element_type, 
  ...
  SELECT 'TABLE_COLUMN' AS element_type, 'MODULERUNTIMES.GLOBALROWID' AS element_name, 'NUMERIC(19) NOT NULL DEFAULT NEXT VALUE FOR GLOBALROWIDSEQUENCE' AS element_content, 'default_constraint_name=DEF_ModuleRunTimes_rowId' AS element_info UNION

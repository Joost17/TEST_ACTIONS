...
-- 4. sqlplus <username>/<password>@<server>:<port>/<servicename> @validate_schema_202002.sql
...
DEFINE validateVersion=validate_schema_202002
...
PROMPT Listing all the differences with Delft-FEWS database that has been migrated to 2020.02. Writing validation results to &spool_filename. This may take a several minutes...;
